...
```{r pressure1, echo=FALSE, fig.cap="Theme trajectory for NYT Articles"}
knitr::include_graphics("C:/Users/kokil/Dropbox/job/nus campus visit/teaching/traj1.png")
```

```{r pressure2, echo=FALSE, fig.cap="Theme trajectory for NYT Comments"}
knitr::include_graphics("C:/Users/kokil/Dropbox/job/nus campus visit/teaching/traj2.png")
```